	...
	<div class="container">
		...
		<div class="row">
			<div class="span12">
				...
				PreparedStatement ps = con.prepareStatement("select * from statistics");
				...
				while(rs.next())
				{
					...
					System.out.println("Category Name="+category +"Product Name="+p_name +"Quantity="+quantity);
				...
				window.onload = function () {
					var chart = new CanvasJS.Chart("chartContainer", {
						title: {
							text: "Product Sale Statistic Analysis Graph"
						},
						data: [{
							type: "column",
							dataPoints: [
								<%-- { y: <%=category%>, label: "Category" },
								{ y: <%=p_name%>, label: "Product Name" },
								{ y: <%=quantity%>, label: "Quantity" }, --%>
								{ y: <%=quantity %>, label: "<%=category%>" },
								{ y: <%=quantity %>, label: "<%=category%>" },
							]
						}]
					});
	...
	<script src="jquery.canvasjs.min.js"></script>
			...
			<script src="canvasjs.min.js"></script>
				<div id="chartContainer" style="height: 400px; width: 500px;"></div>
					<a href="adminHome.jsp"><img src="Images/back.png" height=30px align="left"></a><br>
				</div>
			<br /><br /><br />
								</div>
							</div>
